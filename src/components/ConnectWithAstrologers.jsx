...
const ConnectWithAstrologers = () => {
  return (
    <section className="py-16 bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 text-white">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-white/80 mb-6">Speak directly with an astrologer for a personalized voice consultation.</p>
            ...
            <motion.div
              ...
              className="bg-white/20 backdrop-blur-md p-8 rounded-xl shadow-xl hover:bg-white/30 transition-all"
            >
              <MessageSquareText className="h-12 w-12 mx-auto mb-4 text-white" />
              <h3 className="text-2xl font-semibold mb-2">Chat with Astrologer</h3>
              <p className="text-white/80 mb-6">Get your questions answered through a live chat session with an expert.</p>
              <Button size="lg" className="bg-white text-yellow-600 hover:bg-gray-100 w-full font-semibold">
                Start Chat
              </Button>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/80 mb-6">Connect face-to-face with astrologers for an immersive experience.</p>
